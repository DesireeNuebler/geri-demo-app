...
st.info("  \nThe values of GH, IGF-1, Cortisol and HOMA have been logarithmized.  \n  \n  \nThe feature with the biggest contribution does not have to be the one with the biggest global importance. Non-linear relatioships suggest differently strong contributions based on the concrete patient profile.")

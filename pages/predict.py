...
st.info("The predicted probability serves as a risk estimate and lies between 20% and 60% focusing on reliable probabilities. \
Given a decision in favor of GH-resistance for predicted probabilities > 0.49 resulted in 1 out of 3 correctly detected GH-resistant patients in model testing procedure.")
